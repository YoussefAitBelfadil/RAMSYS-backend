<form action="{{ route('ecran.store') }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="row m-2 d-grid gap-1" style="grid-template-columns: repeat(3, 2fr); grid-gap: 10px;">
            ...
            <div class="p-2">
                <input type="file" id="Image4" name="Image4" class="form-control text-center" placeholder="Image" required>
                <span class="text-danger error-message" id="error-Image"></span>
            </div>

            <div class="p-2">
                <input type="file" id="Image5" name="Image5" class="form-control text-center" placeholder="Image" required>
                <span class="text-danger error-message" id="error-Image"></span>
            </div>
        </div>
